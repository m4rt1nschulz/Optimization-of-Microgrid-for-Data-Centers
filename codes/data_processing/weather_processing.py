...
def main():
    ...
    weather_file = "codes-martin\data\gif_weather_tmy-2022.csv"
    ...
    df_solar.to_csv("vessim_solar_gif.csv")
    ...
    with open(wind_ready_file, 'w', newline='\n') as f:
        ...
        f.write("12345,Gif-sur-Yvette,IDF,France,2022,48.7,2.13,100\n")
        # Row 2: Description (PySAM completely ignores this, but it MUST be here to push Row 3 down!)
        f.write("NREL Weather Data Extrapolated to 80m by Pandas\n")
    ...
    df_wind.to_csv("vessim_wind_gif.csv")
    ...
    fig.suptitle("Seasonal Renewable Energy Profiles - Gif-sur-Yvette, France", 
