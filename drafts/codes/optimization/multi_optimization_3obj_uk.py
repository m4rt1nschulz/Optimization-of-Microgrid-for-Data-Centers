...
class SystemSizingProblem(ElementwiseProblem):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        capex_battery = bat_cap * 100 / 5   # 100 kg CO2 per kWh divided by 5 years of battery life to get annualized emissions
        ...
        battery_capex_cost = bat_cap * 450 / 5     # €450 per kWh divided by 5 years
...
if __name__ == "__main__":
    ...
    if res.X is not None:
        ...
        ax.set_title('Pareto Front: Carbon Trade-offs vs. Total Annual Cost', fontsize=20, fontweight='bold')
